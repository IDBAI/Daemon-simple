...
JNIEXPORT void JNICALL Java_com_revenco_daemonsdk_natives_nativ_NativeDaemonAPI20_doDaemon(JNIEnv *env, jobject jobj, jstring pkgName, jstring svcName, jstring daemonPath){
