...
JNIEXPORT void JNICALL Java_com_revenco_daemon_natives_nativ_NativeDaemonAPI20_doDaemon(JNIEnv *env, jobject jobj, jstring pkgName, jstring svcName, jstring daemonPath){
