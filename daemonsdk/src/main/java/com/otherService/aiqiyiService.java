...
public class aiqiyiService extends BaseService {
    @Override
    public String getServieName() {
        return getClass().getSimpleName();
    }
//    private static final String TAG = "aiqiyiService";
//
//    public aiqiyiService() {
//    }
//
//    @Override
...
//        String XLog = "伪造爱奇艺 aiqiyiService ，发送自定义广播";
