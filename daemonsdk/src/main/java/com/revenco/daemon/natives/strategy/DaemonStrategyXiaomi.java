package com.revenco.daemon.natives.strategy;
...
import com.revenco.daemon.natives.IDaemonStrategy;
import com.revenco.daemon.natives.nativ.NativeDaemonAPI20;
	...
	private boolean startServiceByAmsBinder(){
		try {
			if(mRemote == null || mServiceData == null){
				XLog.e("Daemon", "REMOTE IS NULL or PARCEL IS NULL !!!");
				return false;
			}
